...
defineComponentDefinition( // [!code focus:100]
	...
	/* [!hint: setup:] */({ slot }) => {
		...
		slot(/* [!hint: childId:] */'child-in-default-slot'); /* [!annotation: (a)] */
		// add the child at the end of a named slot
		slot(/* [!hint: childId:] */'child-in-named-slot', /* [!hint: slotName:] */'footer'); /* [!annotation: (b)] */
		// add the child at the start of a named slot
		slot(/* [!hint: childId:] */'child-at-the-start', /* [!hint: slotName:] */'default', /* [!hint: index:] */0); /* [!annotation: (c)] */
		// add the child at any index of a named slot
		slot(/* [!hint: childId:] */'child-at-index', /* [!hint: slotName:] */'default', /* [!hint: index:] */ 1); /* [!annotation: (d)] */
